...
if (isset($JSONAPI)) {
    $call = $JSONAPI->callMultiple(
        // Befehle
        array("worlds.names", "server.settings.ip", "server.settings.port", "server.version", "server.settings.motd", "server.performance.memory.total", "server.performance.memory.used", "getPlayerLimit", "getPlayerCount", "players.online.names", "getBukkitVersion", "plugins",),
        // Parameter 
...
foreach($call[11]['success'] as $key => $value) {
    ...
    $plugins .= '    
        ...
        <div class="info_plugins">
            ...
            <span>            
                <label for="showPluginInfoButton_'.$plugin_count.'" id="showPluginInfo_'.$plugin_count.'">
...
<div class="mcpanel wrap">
    ...
    <div class="JSONAPI">
        ...
        <div class="JSONAPI-Server">
            <table class="info">
                <tr>
                    <td class="text">Weltname:</td>
                    <td class="data"><?php echo $call[0]['success'][0]; ?> (<?php echo $call[0]['success'][1]; ?>)</td>
