...
if( !class_exists( 'MCPanel' ) ) {    
    ...
    class MCPanel {
        ...
        function activate() {
            ...
            add_action('admin_enqueue_scripts', array(&$this, 'mcp_styles'));
            add_action('wp_enqueue_scripts', array(&$this, 'mcp_styles'));
            ...
            wp_register_sidebar_widget(
                ...
                array('description' => 'Zeigt eine Minecraft-Chatbox an.')
            );
            wp_register_widget_control(
                'mcpchatwidget',
                'mcpchatwidget',
        ...
        function deactivate() {
            ...
            remove_action('admin_enqueue_scripts', array(&$this, 'mcp_styles'));
